...
const mockAllocations: AllocationItem[] = [
  { name: 'US Stocks', value: 50.0, amount: 250000, dailyChangePercent: 1.20 },
  { name: 'International Stocks', value: 30.0, amount: 150000, dailyChangePercent: -0.80 },
  { name: 'Bonds', value: 20.0, amount: 100000, dailyChangePercent: 0.50 },
];
  ...
  return (
    ...
    >
      <Box sx={{ 
        ...
        <Typography variant="h6" sx={{ fontWeight: 500 }}>Portfolio Allocation</Typography>
      </Box>
            ...
            <Box sx={{ py: 2 }}>
              <Box sx={{ 
                ...
                <Box sx={{ textAlign: 'right' }}>
                  ...
                  >
                    {item.dailyChangePercent >= 0 ? '+' : ''}{item.dailyChangePercent.toFixed(1)}%
                  </Typography>
                </Box>
              </Box>
              <LinearProgress 
